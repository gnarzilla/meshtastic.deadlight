...
typedef struct _meshtastic_Routing {
    ...
    union _meshtastic_Routing_variant {
...
typedef struct _meshtastic_MeshPacket {
 ...
 This 'trick' is only used while the payload_variant is an 'encrypted'. */
    uint32_t channel;
    pb_size_t which_payload_variant;
    union _meshtastic_MeshPacket_payload_variant {
        /* TODO: REPLACE */
...
typedef struct _meshtastic_FromRadio {
 ...
 see our bluetooth docs */
    uint32_t id;
    pb_size_t which_payload_variant;
    union _meshtastic_FromRadio_payload_variant {
        /* Log levels, chosen to match python logging conventions. */
...
typedef struct _meshtastic_ToRadio {
    pb_size_t which_payload_variant;
    union _meshtastic_ToRadio_payload_variant {
